...
CMD_DIRTY_SET = 0x74
CMD_PATTERN_CHANGE = 0x75
CMD_GENERATOR_LOCK_SET = 0x76
CMD_CHECKPOINT = 0x77
CMD_REVERT = 0x78
CMD_ANCHOR_PRESENT = 0x79
CMD_PHRASE_CAPTURE = 0x7a
CMD_PHRASE_RECALL = 0x7b
...
CMD_SWITCH_PERF = 0x44  # passive pattern-switch freeze probe — sub-op: 0=arm, 1=read (+4/+2 gap + margin state)
...
class CC:
    ...
    MODE = 0x40
    MODE_FLAGS = 0x41
    EVENT_MODE = 0x42  # SEQ_EVENT_MODE_t: 0=Note 1=Chord 2=CC 3=Drum 4=Combined
    BUSASG = 0x45
    MIDI_CHANNEL = 0x46
    MIDI_PORT = 0x47
    DIRECTION = 0x48
