...
#endif
          } else if( strcmp(parameter, "UiInsselDrumTrigger") == 0 ) {
#ifndef MBSEQV4L
            seq_ui_options.INSSEL_DRUM_TRIGGER = value;
#endif
          } else if( strcmp(parameter, "UiInsselKbdScaleDegree") == 0 ) {
#ifndef MBSEQV4L
            seq_ui_options.INSSEL_KBD_SCALE_DEGREE = value;
#endif
          } else if( strcmp(parameter, "UiInsselKbdChord") == 0 ) {
#ifndef MBSEQV4L
...
#ifndef MBSEQV4L
  sprintf(line_buffer, "UiInsselDrumTrigger %d\n", seq_ui_options.INSSEL_DRUM_TRIGGER);
  FLUSH_BUFFER;
#endif

#ifndef MBSEQV4L
  sprintf(line_buffer, "UiInsselKbdScaleDegree %d\n", seq_ui_options.INSSEL_KBD_SCALE_DEGREE);
  FLUSH_BUFFER;
#endif
